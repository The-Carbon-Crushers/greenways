...
urlpatterns = [
    ...
    path('travel-learn/', travel_learn_page, name='learn'),  # Change 'Sustainable Travel' to 'learn'
    path('food-learn/', food_learn_page, name='learn'),  # Change 'Sustainable Food' to 'learn'
    path('building-learn/', building_learn_page, name='learn'),  # Change 'Sustainable Building' to 'learn'
